	...
	return (
		<div className="grid grid-cols-[400px_1fr]">
			<aside className="flex flex-col justify-between min-h-screen p-4 bg-gray-900">
				...
				<section>{/* aquivan los filtros */}</section>

				<footer> Desarrollo por JavierR.</footer>
			</aside>
...
//URL EXAMPLE TO EXECUTE THE APP
// https://www.groovehq.com/blog/wp-content/uploads/2018/07/where_are_we.png
